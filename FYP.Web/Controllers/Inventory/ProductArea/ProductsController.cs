...
namespace FYP.Web.Controllers.Inventory.ProductArea
{
    ...
    public class ProductsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("product_id,name,description,quantity,unit_price,category_id,reorder_level,discontinued")] Product product)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("product_id,name,description,quantity,unit_price,category_id,reorder_level,discontinued")] Product product)
        {
