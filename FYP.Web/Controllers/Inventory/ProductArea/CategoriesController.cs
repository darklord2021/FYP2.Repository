    ...
    public class CategoriesController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Categories != null ? 
                          ...
                          Problem("Entity set 'FYPContext.Categories'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("category_id,category_name,Description,created_on,last_modified")] Category category)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("category_id,category_name,Description,created_on,last_modified")] Category category)
        {
