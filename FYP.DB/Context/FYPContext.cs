...
public partial class FYPContext : DbContext
{
    ...
    public virtual DbSet<Billing_Address> Billing_Addresses { get; set; }

    public virtual DbSet<Category> Categories { get; set; }

    //public virtual DbSet<Chart_of_Account> Chart_of_Accounts { get; set; }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        {
            entity.Property(e => e.paid).HasDefaultValueSql("(CONVERT([bit],(0)))");
        ...
        modelBuilder.Entity<Billing_Address>(entity =>
        {
            entity.Property(e => e.id).ValueGeneratedNever();

            entity.HasOne(d => d.customer).WithMany(p => p.Billing_Addresses)
        ...
        //modelBuilder.Entity<Chart_of_Account>(entity =>
        //{
        ...
        modelBuilder.Entity<Shipping_Address>(entity =>
        {
            ...
            entity.HasOne(d => d.customer).WithMany(p => p.Shipping_Addresses)
                .OnDelete(DeleteBehavior.ClientSetNull)
